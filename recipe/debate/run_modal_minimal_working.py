...
@app.function(
    ...
    timeout=4 * 60 * MINUTES,#24 * 60 * MINUTES,
...
def train(*arglist) -> None:
    cmd: list[str] = [
        ...
        "actor_rollout_ref.model.path=Qwen/Qwen2-0.5B-Instruct",#Qwen/Qwen3-4B-Instruct-2507",#meta-llama/Llama-3.1-8B-Instruct",#google/gemma-3-12b-it",
        ...
        f"trainer.default_local_dir={MODELS_PATH / "low__lr"}",
        ...
        "reward_model.model.path=Qwen/Qwen2-0.5B-Instruct",#Qwen/Qwen3-4B-Instruct-2507",#google/gemma-3-4b-it",
